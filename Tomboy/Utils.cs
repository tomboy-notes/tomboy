...
namespace Tomboy
{
	...
	public class TomboyGConfXKeybinder : GConfXKeybinder
	{
		...
		const string MENU_BINDING = BINDINGS + "show_note_menu";
		const string START_BINDING = BINDINGS + "open_start_here";
		const string NEW_NOTE_BINDING = BINDINGS + "create_new_note";
		const string SEARCH_BINDING = BINDINGS + "open_search";
		const string RECENT_BINDING = BINDINGS + "open_recent_changes";
