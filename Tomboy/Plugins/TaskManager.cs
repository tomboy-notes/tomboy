...
#region Constructors
	...
	public TaskManager (string directory, string archive_directory) 
	{
		...
		Tomboy.Tomboy.ExitingEvent += OnExitingEvent;
		TasksPlugin.TasksPluginShutdownEvent += OnTasksPluginShutdownEvent;
	}
...
#region Event Handlers
	...
	void OnTasksPluginShutdownEvent (object sender, EventArgs args)
	{
		OnExitingEvent (sender, args);
	}
